...
```
| Rank | Harness | Task | hint-AUC ↑ | cov-AUC | L0 pass@k | 最低可解 hint | rubric 峰值 | 探针洁净度 | 复核 | 错误 | 成本 |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | open-precutoff-strong+mock-deep | kakeya_3d_wang_zahl | 0.340 | 0.586 | 0% | L3 | 100% | ✅ clean | 13 | 0 | 74.5 |
| 2 | open-precutoff-mid+mock-vanilla | kakeya_3d_wang_zahl | 0.140 | 0.477 | 0% | L4 | 100% | ✅ clean | 1 | 0 | 71.8 |
| 3 | open-precutoff-weak+mock-vanilla | kakeya_3d_wang_zahl | 0.100 | 0.471 | 0% | L5 | 100% | ✅ clean | 0 | 0 | 67.3 |
